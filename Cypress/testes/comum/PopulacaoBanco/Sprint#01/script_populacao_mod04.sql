...
VALUES (1,0,0,'Que foto incrível! Adoro a paisagem de fundo, você arrasa sempre!',1);
INSERT INTO `comentarios` (`CMT_TIPO_POSTAGEM`,`CMT_FK_ID_POSTAGEM`,`CMT_CURTIDAS`,`CMT_TEXTO`,`FK_USUARIOS_USU_ID`) 
VALUES (1,0,0,'Estou muito orgulhoso(a) de você por alcançar isso!',1);
INSERT INTO `comentarios` (`CMT_TIPO_POSTAGEM`,`CMT_FK_ID_POSTAGEM`,`CMT_CURTIDAS`,`CMT_TEXTO`,`FK_USUARIOS_USU_ID`) 
VALUES (1,0,0,'Você merece todo sucesso do mundo!',1);
...
INSERT INTO `postagens_geral` (`PST_DESCRICAO`, `PST_CURTIDAS`, `PST_DATA`, `PST_IMAGEM`, `PST_ID`, `FK_USUARIOS_USU_ID`) VALUES ('Futebol muito legal haha', '0', '2023-09-04', '20230904_093847_7af6a3cb-b0d6-4a6e-930d-5841ad842316.jpeg', NULL, '1')
