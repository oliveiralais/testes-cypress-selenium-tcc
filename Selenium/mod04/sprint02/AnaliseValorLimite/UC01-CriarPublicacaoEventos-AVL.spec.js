...
describe("Criar publicação de Evento - Análise Valor Limite", function () {
    ...
    it.only("Verificando título da publicação com tamanho 254 (Limite Superior -1)", async function () {
